/*
    ...
    OpenGL loader generated by glad 0.1.36 on Wed May 28 20:54:46 2025.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.6" --generator="c" --spec="gl" --extensions="GL_ARB_ES2_compatibility,GL_ARB_ES3_compatibility,GL_ARB_base_instance,GL_ARB_clear_buffer_object,GL_ARB_compressed_texture_pixel_storage,GL_ARB_compute_shader,GL_ARB_conservative_depth,GL_ARB_copy_image,GL_ARB_get_program_binary,GL_ARB_internalformat_query,GL_ARB_invalidate_subdata,GL_ARB_map_buffer_alignment,GL_ARB_multi_draw_indirect,GL_ARB_program_interface_query,GL_ARB_robust_buffer_access_behavior,GL_ARB_robustness,GL_ARB_robustness_isolation,GL_ARB_separate_shader_objects,GL_ARB_shader_atomic_counters,GL_ARB_shader_image_load_store,GL_ARB_shader_image_size,GL_ARB_shader_storage_buffer_object,GL_ARB_shading_language_420pack,GL_ARB_shading_language_packing,GL_ARB_stencil_texturing,GL_ARB_texture_buffer_range,GL_ARB_texture_query_levels,GL_ARB_texture_storage,GL_ARB_texture_storage_multisample,GL_ARB_texture_view,GL_ARB_transform_feedback2,GL_ARB_transform_feedback3,GL_ARB_transform_feedback_instanced,GL_ARB_vertex_attrib_64bit,GL_ARB_vertex_attrib_binding,GL_ARB_viewport_array,GL_EXT_bindable_uniform,GL_EXT_framebuffer_blit,GL_EXT_framebuffer_multisample,GL_EXT_framebuffer_object,GL_EXT_geometry_shader4,GL_EXT_gpu_shader4,GL_EXT_packed_depth_stencil,GL_EXT_texture_array,GL_EXT_texture_buffer_object,GL_EXT_texture_compression_s3tc,GL_EXT_texture_filter_anisotropic,GL_EXT_texture_integer,GL_EXT_texture_sRGB,GL_EXT_transform_feedback"
    Online:
        Too many extensions
*/
